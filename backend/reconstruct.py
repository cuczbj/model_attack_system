...
6.学习率
"""
def reconstruct(attack_method_name, model, G, target_label,  h, w, channel, device, task_id=None):
    ...
    try:
        ...
        # 传递任务ID给攻击方法
        result = attack_method(target_label, model, G, h, w, channel, device, task_id)
        return result
